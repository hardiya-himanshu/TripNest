  ...
  return (
    <section className='hotel_section reveal' id='hotel_section'>
      ...
      <div className="hotels_cards_section">
        ...
        <Hotel_Card hotelImage={hotel3} hotelName="Ibis Bangkok Sathorn" hotelLocation="Bangkok, Thailand" hotelType="Relax" hotelPrice=" 8,999/Night" to="/hotels/3"/>
        <Hotel_Card hotelImage={hotel5} hotelName="Mövenpick Resort Al Marjan" hotelLocation="Ras al Khaimah, UAE" hotelType="Royal" hotelPrice=" 13,999/Night" to="/hotels/4"/>
        <Hotel_Card hotelImage={hotel4} hotelName="Hyatt Regency Paris Étoile" hotelLocation="Paris, France" hotelType="Cozy" hotelPrice=" 12,999/Night" to="/hotels/5"/>
      </div>
