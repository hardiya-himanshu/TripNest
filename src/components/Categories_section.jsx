    ...
    <div className='categories_section'>
        ...
        <div className="categories_content">
            ...
            <div className="categories_grid grid grid-cols-4 grid-rows-3 gap-4">
                <Categories_card className="categories_card_section col-span-3 " categories_card_name="ASIA" categories_card_image={asia} categories_card_nameclass="categories_card_name -right-10"/>
                ...
                <Categories_card className="categories_card_section" categories_card_name="ANTARCTICA" categories_card_image={antarctica}  categories_card_nameclass="categories_card_name"/>
                <Categories_card className="categories_card_section col-span-2" categories_card_name="OCEANIA" categories_card_image={oceania}  categories_card_nameclass="categories_card_name"/>
