...
function Acc_Set_PD() {
  return (
    <div className='p-7 flex flex-col gap-12 w-96' >
      ...
      <div className="acpd_content flex flex-col justify-center items-center gap-5 rounded-lg w-72">
        ...
        <input type="button" value="APPLY" className='rounded-lg w-1/4 text-black font-semibold h-8 bg-white cursor-pointer' />
    </div>
  )
}
