  ...
  return (
    <div className='p-7 flex flex-col gap-12' >
      ...
      <div className="acsd_content flex flex-col justify-center items-center gap-5 rounded-lg w-72">
        ...
        <input type="text" className='rounded-lg w-full h-10 p-3' placeholder='CURRENT PASSWORD'/>
        <input type="text" className='rounded-lg w-full h-10 p-3' placeholder='NEW PASSWORD'/>
        <input type="text" name="" id="" className='rounded-lg w-full h-10 p-3' placeholder='CONFIRM PASSWORD' />
